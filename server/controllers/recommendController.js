...
2) 스톱 수: 하루 3~5개(이동 동선 자연스럽게). Day 1부터 Day ${days}까지 모든 날짜를 포함해야 한다.
...
6) 예산 분배(1인 기준):
   - 전체 합계(overallTotal) ∈ [${Math.round(budgetPerPerson * 0.9)}, ${Math.round(budgetPerPerson * 1.1)}] (가능하면 99~100% 소진)
...
- overallTotal ∈ [${Math.round(budgetPerPerson * 0.99)}, ${budgetPerPerson}] (가급적 99~100%)
